									...
									<div class="block-widget-wrap">
										<div class="slick-sliders" data-autoplay="true" data-dots="true"
											...
											<div class="item slick-slide">
												<div class="item-content">
													<div class="content-image">
														<img width="1920" height="1080" src="media/slider/4.jpg"
															alt="Image Slider">
													</div>
											...
											<div class="item slick-slide">
												<div class="item-content">
													<div class="content-image">
														<img width="1920" height="1080" src="media/slider/5.jpg"
															alt="Image Slider">
													</div>
													<div class="item-info horizontal-start vertical-middle">
														<div class="content">
											...
											<div class="item slick-slide">
												<div class="item-content">
													<div class="content-image">
														<img width="1920" height="1080" src="media/slider/6.jpg"
															alt="Image Slider">
													</div>
													<div class="item-info horizontal-start vertical-middle">
														<div class="content">
														...
														<div class="banner-wrapper banners">
															<div class="banner-image">
																<a href="shop-grid-left.html">
																	<img width="568" height="607"
																		src="media/banner/banner-3.jpg"
																		alt="Banner Image">
																</a>
															</div>
															...
															<div class="banner-wrapper-infor text-center">
																<div class="info">
																	<div class="content">
																		...
																		<a class="button btn-underline center"
																			href="shop-grid-left.html">shop now</a>
																	</div>
																</div>
															</div>
										...
										<div class="block-content">
											<div class="products-list grid">
												<div class="row">
														...
														<div class="items">
															<div class="products-entry clearfix product-wapper">
																...
																<div class="products-content">
																	<div class="contents text-center">
																		<h3 class="product-title"><a
																				href="shop-details.html">Spinning
																				pendant lamp</a></h3>
																		<span class="price">
																			<del
																				aria-hidden="true"><span>$150.00</span></del>
														...
														<div class="items">
															<div class="products-entry clearfix product-wapper">
																...
																<div class="products-content">
																	<div class="contents text-center">
																		<h3 class="product-title"><a
																				href="shop-details.html">Bora
																				Armchair</a></h3>
																		<span class="price">
																			<del
																				aria-hidden="true"><span>$100.00</span></del>
														...
														<div class="items">
															<div class="products-entry clearfix product-wapper">
																...
																<div class="products-content">
																	<div class="contents text-center">
																		<h3 class="product-title"><a
																				href="shop-details.html">Panton Dining
																				Table</a></h3>
																		<span class="price">
																			<del
																				aria-hidden="true"><span>$79.00</span></del>
														...
														<div class="items">
															<div class="products-entry clearfix product-wapper">
																...
																<div class="products-content">
																	<div class="contents text-center">
																		<h3 class="product-title"><a
																				href="shop-details.html">Kittchen
																				Table</a></h3>
															...
															<div class="products-entry clearfix product-wapper">
																...
																<div class="products-content">
																	<div class="contents text-center">
																		...
																		<span class="price">
																			<del
																				aria-hidden="true"><span>$200.00</span></del>
													...
													<div
														class="col-xl-3 col-lg-4 col-md-4 col-sm-6 product-loadmore hide">
														<div class="items">
															<div class="products-entry clearfix product-wapper">
																<div class="products-thumb">
																	<div class="product-lable">
												...
												<div class="lookbook-wrap default">
													<div class="lookbook-container">
														<div class="lookbook-content">
															<div class="item">
																<img width="869" height="702"
																	src="media/banner/lookbook-1.jpg" alt="Look Book 1">
																<div class="item-lookbook"
																	style="height:30px; width:30px; left:78.37%; top:50%">
																	<span class="number-lookbook">1</span>
																	<div class="content-lookbook"
																		style="right:33px; top:10px;">
																		<div class="item-thumb">
																			<a href="shop-details.html">
																				<img width="1000" height="1000"
																					src="media/product/7.jpg" alt="">
																			</a>
																		</div>
																		<div class="content-lookbook-bottom">
																			<div class="item-title">
																				<a href="shop-details.html">Pillar
																					Dining Table Round</a>
																			</div>
																			<span class="price">
																				<del
																					aria-hidden="true"><span>$150.00</span></del>
																...
																<div class="item-lookbook"
																	style="height:30px; width:30px; left:34.06%; top:74.22%">
																	<span class="number-lookbook">2</span>
																	<div class="content-lookbook"
																		style="left:33px; bottom:10px;">
																		<div class="item-thumb">
																			<a href="shop-details.html">
																				<img width="1000" height="1000"
																					src="media/product/4.jpg" alt="">
																			</a>
																		</div>
																		<div class="content-lookbook-bottom">
																			<div class="item-title">
																				<a href="shop-details.html">Mags Sofa
																					2.5 Seater</a>
																			</div>
																			<span class="price">$150.00</span>
																		</div>
									...
									<div class="block-widget-wrap">
										<div class="testimonial-wrap slick-wrap">
											<div class="slick-sliders" data-slidestoscroll="true" data-nav="1"
												data-dots="0" data-columns4="1" data-columns3="1" data-columns2="1"
														...
														<div class="testimonial-image image-position-top">
															<div class="thumbnail">
																<img width="62" height="62"
																	src="media/testimonial/1.jpg" alt="">
															</div>
												...
												<div class="testimonial-content">
													<div class="item">
														...
														<div class="testimonial-image image-position-top">
															<div class="thumbnail">
																<img width="62" height="62"
																	src="media/testimonial/2.jpg" alt="">
															</div>
															<div class="testimonial-info">
												...
												<div class="testimonial-content">
													<div class="item">
														...
														<div class="testimonial-image image-position-top">
															<div class="thumbnail">
																<img width="62" height="62"
																	src="media/testimonial/3.jpg" alt="">
															</div>
															<div class="testimonial-info">
